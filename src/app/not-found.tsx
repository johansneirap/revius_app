...
export default function NotFound() {
  return (
    <div className="bg-background-light dark:bg-background-dark font-display flex min-h-screen flex-col text-slate-900 dark:text-slate-100">
      {/* Header / Navigation */}
      ...
      <main className="flex flex-grow flex-col items-center justify-center px-4 py-12">
        <div className="w-full max-w-3xl text-center">
          ...
          <div className="relative mb-8 inline-block">
            <div className="bg-primary/10 dark:bg-primary/20 mx-auto mb-6 flex h-48 w-48 items-center justify-center rounded-full">
              <span className="material-icons text-primary text-8xl">
                production_quantity_limits
              </span>
            </div>
            <div className="absolute -top-2 -right-2 rounded-full border border-slate-100 bg-white p-3 shadow-lg dark:border-slate-700 dark:bg-slate-800">
          ...
          <p className="mx-auto mb-8 max-w-lg text-lg text-slate-600 dark:text-slate-400">
            No te preocupes, aún puedes encontrar lo que buscas usando el
            buscador o revisando nuestras recomendaciones destacadas.
          </p>
          ...
          <div className="relative mx-auto mb-8 max-w-xl">
            <div className="flex items-center overflow-hidden rounded-xl border border-slate-200 bg-white p-1 shadow-md dark:border-slate-800 dark:bg-slate-900">
              ...
              <input
                ...
                type="text"
              />
              <button className="bg-primary hover:bg-primary/90 rounded-lg px-6 py-2.5 font-semibold text-white transition-all">
                Buscar
              </button>
            </div>
          </div>
          ...
          <Link
            href="/"
            className="group text-primary inline-flex items-center gap-2 font-semibold hover:underline"
          >
          ...
          <div>
            ...
            <div className="flex gap-2">
              <input
                ...
                type="email"
              />
              <button className="bg-primary rounded-lg p-2 text-white">
  ...
  return (
    <div className="group overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm transition-shadow hover:shadow-md dark:border-slate-800 dark:bg-slate-900">
      <div className="relative aspect-square overflow-hidden bg-slate-100 dark:bg-slate-800">
        ...
        {badge && (
          <div
            className={`absolute top-2 left-2 rounded px-2 py-1 text-[10px] font-bold text-white ${badgeColor}`}
          >
            {badge}
          </div>
        )}
      ...
      <div className="p-4">
        ...
        <div className="flex items-center justify-between">
          ...
          <button className="text-primary hover:bg-primary rounded-lg bg-slate-100 p-2 transition-colors hover:text-white dark:bg-slate-800">
